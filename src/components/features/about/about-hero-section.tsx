          ...
          <div className="lg:col-span-7 space-y-5">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">
                Turning complex problems into elegant, fast, and scalable software.
              </h2>
            </div>

            <div className="space-y-3.5 text-xs sm:text-sm leading-relaxed text-muted-foreground">
              <p>
                Hello! I'm <strong className="text-foreground font-semibold">Carl Joseph</strong>, a full-stack engineer and mobile application developer based in the Philippines. I specialize in designing and shipping production-ready web platforms, headless commerce solutions, SaaS applications, and interactive mobile apps.
              </p>
              <p>
                My engineering approach is grounded in <span className="text-foreground font-medium">performance, clean architectural design, and rigorous type safety</span>. I believe great software isn't just about making pixels look good on screen—it's about building resilient systems that load instantly, handle edge cases gracefully, and provide effortless experiences for end users.
              </p>
              <p>
                Whether collaborating with agile startup teams, helping founders launch MVP products, or building enterprise workflows from scratch, I focus on delivering tangible business value with speed and precision.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-2">
              <div className="rounded-xl border border-border/60 bg-muted/20 p-3">
                ...
                <div className="font-bold text-xs text-foreground">High Speed</div>
                <div className="font-mono text-[10.5px] text-muted-foreground">Sub-second loads</div>
              </div>
              <div className="rounded-xl border border-border/60 bg-muted/20 p-3">
                <ShieldCheck className="h-4 w-4 text-foreground mb-1.5" />
                <div className="font-bold text-xs text-foreground">Type-Safe</div>
                <div className="font-mono text-[10.5px] text-muted-foreground">TypeScript first</div>
              </div>
              <div className="rounded-xl border border-border/60 bg-muted/20 p-3 col-span-2 sm:col-span-1">
                ...
                <div className="font-bold text-xs text-foreground">Maintainable</div>
                <div className="font-mono text-[10.5px] text-muted-foreground">Modular clean code</div>
              </div>
            </div>
          </div>
        </div>
