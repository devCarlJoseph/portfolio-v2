...
export function AboutHeroBanner() {
  return (
    ...
    >
      ...
      <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3.5 py-1 text-xs font-medium text-foreground self-center sm:self-auto shadow-xs">
